const CONTENT_QUALITY = {
  ...
  Transform: {
    tier: "documented",
    label: "Ready for Nuke audit · 16 arguments",
    hideDescription: true,
    ...
    argumentOverrides: {
      ...
      matrix: { description: "Underlying 4×4 transform matrix generated by the visible transform controls. Usually edited through Translate, Rotate, Scale, Skew, and Center." },
