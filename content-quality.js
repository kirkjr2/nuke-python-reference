const CONTENT_QUALITY = {
  ...
  Transform: {
    tier: "needs-research",
    label: "Nuke-tested · 15/16 passed · matrix needs retest",
    hideDescription: true,
    ...
    argumentOverrides: {
      ...
      matrix: {
        ...
        description: "Underlying 4×4 transform matrix generated by the visible transform controls. It is not a string value; script it component-by-component or use the higher-level Translate, Rotate, Scale, Skew, and Center knobs."
      },
