  ...
  Transform: {
    ...
    argumentOverrides: {
      ...
      matrix: {
        ...
        description: "Underlying 4×4 transform matrix generated by the visible transform controls. Write its 16 numeric components with setValue(value, index); value() returns a Matrix4. Usually the higher-level Translate, Rotate, Scale, Skew, and Center knobs are easier to use."
      },
