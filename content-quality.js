const CONTENT_QUALITY = {
  ...
  Transform: {
    tier: "needs-research",
    label: "Nuke-tested · 15/16 passed · matrix write passed, readback pending",
    hideDescription: true,
    ...
    argumentOverrides: {
      ...
      matrix: {
        type: "16 numeric components / Transform2d_Knob",
        examplesHtml: '<span class="source-note">Set component-wise</span>',
        description: "Underlying 4×4 transform matrix generated by the visible transform controls. It is not a string value; write it component-by-component with setValue(value, index), and read the complete matrix with value(). Usually the higher-level Translate, Rotate, Scale, Skew, and Center knobs are easier to use."
      },
